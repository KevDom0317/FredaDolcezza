    ...
    <div class="p-6">
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input id="name" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-teal-medium focus:border-teal-medium" type="text" name="name" value="{{ old('name') }}" required autofocus />
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-teal-medium focus:border-teal-medium">{{ old('description') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <input id="price" class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-teal-medium focus:border-teal-medium" type="number" name="price" step="0.01" min="0" value="{{ old('price') }}" required />
            ...
            <div class="mb-6">
                <label class="inline-flex items-center">
                    <input type="checkbox" name="is_available" value="1" {{ old('is_available', true) ? 'checked' : '' }} class="rounded border-gray-300 text-teal-dark shadow-sm focus:ring-teal-medium">
